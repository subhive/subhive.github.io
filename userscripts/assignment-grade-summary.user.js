...
(function() {
	...
	var url = "/api/v1/courses/" + courseId + "/assignments/" + assignmentId + "/submissions?per_page=60";
    ...
    function grades_retrieved(){
        ...
        var grades_count_2 = {}; // count for each reasubmission for grading
