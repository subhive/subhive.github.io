...
(function () {
  ...
  var excusedCheck;
  var gradeHeading;
  var verInfo = $('<span style="font-size:.6em;color:#666666;text-align:right;float:right;margin-top:38px">v3.4</span>');
      ...
      if (assignEl !== null) {
        ...
        if (matches) {
          ...
          var i = setInterval(function () {
            assignEl = document.getElementById('assign-status');
            if (assignEl !== null) {
              clearInterval(i);
              init();
            }
